<html>
    ...
    <body style="background:#e4ebe9">
        <div class="w-100 p-4 d-flex justify-content-between" style="background:midnightblue; font-style:italic; color:white">
    ...
    <div class="container mt-5">
            <form action="transfer1.php" method="post" autocomplete="off" class="w-50 p-3 mx-auto bg-light">
